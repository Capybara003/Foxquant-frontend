    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <Card className="w-full max-w-4xl max-h-[90vh] overflow-hidden">
        <div className="flex items-center justify-between p-6 border-b">
          <h2 className="text-2xl font-bold text-gray-900">Gamification Center</h2>
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex-1">
                        ...
                        {badge.phase && (
                          <span className={`inline-block px-2 py-1 rounded-full text-xs font-medium mt-2 ${getPhaseColor(badge.phase)}`}>
                            {badge.phase}
                          </span>
                        )}
                      </div>
                ...
                {leaderboard.map((entry, index) => (
                  ...
                  >
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <div className="flex items-center space-x-2 text-sm text-gray-600">
                          <span className={`px-2 py-1 rounded-full text-xs font-medium ${getPhaseColor(entry.currentPhase)}`}>
                            {entry.currentPhase}
                          </span>
                    ...
                    <div className="text-right">
                      <div className="text-lg font-bold text-primary-600">{entry.tokens}</div>
